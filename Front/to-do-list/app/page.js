    ...
    <div className='flex flex-col items-center justify-center min-h-screen'>
      ...
      <div className='grid gap-6 w-full max-w-4xl'>
          {data.map(item => (
            <div 
              key={item.id} 
              className='border border-gray-300 px-6 pt-6 rounded-lg shadow-lg text-center transition-transform transform hover:scale-105 hover:shadow-2xl hover:bg-gray-100'
          >
